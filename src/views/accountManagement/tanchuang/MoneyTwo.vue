  ...
  <div class="moneypasswordtwo">
    <div class="moneypasswordtwobox phone">
      ...
      <Form ref="moneytwoform" :model="moneytwoform" :rules="ruleInline" label-position="top">
        <p class="input-title">新支付密码</p>
        <FormItem prop="inputPhonenum" class="whiteTip">
          <Input type="password" placeholder="输入新支付密码" v-model="moneytwoform.inputPhonenum">
        </Input>
        </FormItem>
        <p class="input-title">确认新支付密码</p>
        <FormItem prop="verify" class="whiteTip">
          <Input type="password" placeholder="确认新支付密码" v-model="moneytwoform.verify">
          </Input>
        </FormItem>
